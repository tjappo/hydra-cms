window['faqData'] = [
    ...
    },
    {
        ...
        "category": "About Shift",
        "title": {
            "en": "Can decentralized websites hosted through Shift be experienced on regular desktop and mobile web browsers?"
        },
        "content": {
    ...
    },
    {
        ...
        "category": "About Shift",
        "title": {
            "en": "How does Shift plan to succeed in the market without a war chest of ICO funds?"
        },
        "content": {
    ...
    },
    {
        ...
        "category": "About Shift",
        "title": {
            "en": "Does the Shift dApp platform support sidechains and atomic swaps?"
        },
        "content": {
            "en": "<p>Shift as a dApp platform will definitely support sidechains and atomic swaps. However, they are not implemented yet. In our private repositories we’re really close to the goal of supporting sidechains. Syncing of the sidechain is stable now, which is quite an achievement on its own. The next step is having stable multi-forging.</p><p>We will also introduce atomic swaps in the future using IPLD (InterPlanetary Linked Data).</p>",
        },
        "hidden": false
    },
    {
        ...
        "category": "About Shift",
        "title": {
            "en": "Is Shift capable of hosting dynamic websites, such as social media and e-commerce platforms?"
        },
        "content": {
            "en": "<p>Yes. See our November Newsletter for details about our custom IPFS content management system, called Hydra.</p>"
        },
        "hidden": false
    },
    {
    ...
    },
    {
        ...
        "category": "About Shift",
        "title": {
            "en": "How can the cost of services on the Shift platform remain fixed as the value of the Shift token increases with adoption of the platform?"
        },
        "content": {
            "en": "<p>This will be solved with dynamic fees and block rewards. We will implement this type of solution in the revenue model of the storage nodes as well.</p>"
        },
        "hidden": false
    },
    {
        ...
        "category": "About Shift",
        "title": {
            "en": "What are the ways in which the Shift token's value increases?"
        },
        "content": {
            "en": "<p>The Shift token’s value is likely to increase because it will be used [as a utility coin] to pay for services on our platform. When using your tokens to pay for storage (for example), a certain amount of your tokens will be stored on Phantom’s sidechain and therefore will be locked. This causes a shortage of tokens at our main chain (and the exchanges). A shortage of tokens could mean a value increase at the exchanges.</p>"
        },
        "hidden": false
    },
    {
        ...
        "category": "About Shift",
        "title": {
            "en": "Can Shift be forked or cloned?"
        },
        "content": {
    ...
    },
    {
        ...
        "category": "About Shift",
        "title": {
            "en": "Do you need special programming skills to create Shift applications?"
        },
        "content": {
            "en": "<p>Only JavaScript is needed for creating decentralized applications which run on the Shift network. This allows Shift to have essentially no barrier to mass adoption by regular developers.</p>"
        },
        "hidden": false
    },
    {
