    ...
    <div class="animated fadeIn index-wrapper">
        ...
        <div class="row justfiy-content-center">
            <div class="card w-100">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6" v-for="route in allRoutes">
                            <div class="card card-inverse card-info">
                                <div class="card-block">
                                    ...
                                    <small class="text-muted text-uppercase font-weight-bold">Items on the <strong>{{route}}</strong> component</small>
                                </div>
                                <div class="card-footer p-x-1 py-h">
                                    <b-link class="font-weight-bold font-xs btn-block text-muted" :to="{ name: 'AdminIndex', params: {'name': route} }">View More <i class="fa fa-angle-right float-right font-lg"></i></b-link>
                                </div>
                            </div>
                        </div><!--/.col-->
                    </div>
