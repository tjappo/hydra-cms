      ...
      <div class="card-body">
        ...
        <div
          ...
          <b-btn
            variant="success"
            class="float-right"
            :id="'localPushButton' + key">Push
          </b-btn>
          <b-popover
            :target="'localPushButton' + key"
            title="Confirm Push"
            triggers="focus blur">
            <p>Are you sure about pushing the local <code>{{ item }}</code> folder and, if contained within this folder,
            all files?</p>
            <button
              class="btn btn-xs btn-primary"
              @click.prevent.stop="pushData(item, key)">Yes
            </button>
            <button
